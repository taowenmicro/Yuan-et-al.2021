...
#-----------plsPM--路径虫子微生物群落来源-三组信息#------
library("plspm")
pathplspm = read.csv("./plsPM路径.csv",row.names = 1)
pathplspm
...
# id = c("GCsoil","env_soil","OTUsoil","OTUroot","OTUleaf","GCleaf","env","OTUinsect")
id = c("OTUsoil","GCsoil","GCleaf","env","OTUroot","OTUleaf","OTUinsect","env_soil")
...
filename = paste(interpath,"/PLSPM.pdf",sep = "")
